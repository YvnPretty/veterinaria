        ...
        <div class="row">
            <div class="col-md-12 mb-3">
                ...
                <select class="form-control form-control-vet @error('user_id') is-invalid @enderror" id="user_id" name="user_id">
                    <option value="" selected>-- Dueño no registrado en el sistema --</option>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control form-control-vet @error('nombre_propietario') is-invalid @enderror" id="nombre_propietario" name="nombre_propietario" value="{{ old('nombre_propietario') }}">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control form-control-vet @error('telefono_propietario') is-invalid @enderror" id="telefono_propietario" name="telefono_propietario" value="{{ old('telefono_propietario') }}">
